...
import com.formacionbdi.springboot.app.item.service.InterfaceItemService;
...
public class ItemController {
	...
	@HystrixCommand(fallbackMethod = "itemDefault")
	@GetMapping("/ver/{id}/cantidad/{cantidad}")
	public Item detalle(@PathVariable Long id, @PathVariable Integer cantidad) {
		return itemService.findById(id, cantidad);	
	}
	
	public Item itemDefault(Long id, Integer cantidad) {
		Item item = new Item();
		Producto prod = new Producto();
		prod.setNombre("Porduct-default");
