...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/api/productos/**","/api/items/**","/api/usuarios/**").hasRole("ADMIN") // Todas las operaciones que no sean listar o ver
		.anyRequest().authenticated(); 
		//Esta es la forma extensa especificando las url y los metodos http
		/*		 
